...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'glow-sm': '0 0 10px -3px hsl(var(--glow-primary) / 0.3)',
        'glow': '0 0 20px -5px hsl(var(--glow-primary) / 0.4)',
        'glow-lg': '0 0 30px -5px hsl(var(--glow-primary) / 0.5)',
        'glow-accent': '0 0 20px -5px hsl(var(--glow-accent) / 0.4)',
        'warm': '0 4px 20px -5px hsl(var(--primary) / 0.15)',
